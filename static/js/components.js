                    ...
                    <div class="relative group">
                        ...
                        <div
                            ...
                            <a href="/events" class="block px-4 py-2 hover:bg-green-50 text-gray-700">Events &
                                Celebrations</a>
                            <!-- HIDDEN: <a href="/success-stories" class="block px-4 py-2 hover:bg-green-50 text-gray-700">Success Stories</a> -->
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div id="mobile-beyond" class="hidden pl-4 space-y-2 mt-2">
                        ...
                        <a href="/events" class="block text-gray-600 hover:text-[#009846] py-1">Events &
                            Celebrations</a>
                        <!-- HIDDEN: <a href="/success-stories" class="block text-gray-600 hover:text-[#009846] py-1">Success Stories</a> -->
                    </div>
                </div>
