...
export const Layout = (content: string, title: string, activePage: string = 'home') => {
    ...
    <head>
        ...
        <title>${title} | Dr. SNS College of Education</title>
        <meta name="description" content="Dr. SNS College of Education - Specialized pedagogy subjects integrated with Design Thinking methodologies.">
        ...
        <footer class="bg-gray-900 text-gray-300 py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-3">
                            ...
                            <a href="http://instagram.com/snsinstitutions" target="_blank" class="w-10 h-10 bg-gray-800 hover:bg-orange-600 rounded-lg flex items-center justify-center transition">
                ...
                <div class="border-t border-gray-800 pt-8 text-center text-sm">
                    ...
                    <p class="mt-3 text-orange-400 font-bold"><i class="fas fa-headset mr-2"></i>Admission: +91-90036 55855</p>
                </div>
            </div>
        </footer>
