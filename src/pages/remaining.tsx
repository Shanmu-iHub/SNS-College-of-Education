                ...
                <div class="bg-white rounded-[2rem] p-10 border border-gray-100 shadow-xl flex flex-col h-full hover:shadow-2xl transition duration-500">
                    <div class="flex items-center mb-8">
                        ...
                        <div class="ml-6">
                            ...
                            <p class="text-sky-500 font-bold mt-1 text-sm uppercase tracking-wide">Founder Chairman</p>
                        </div>
                    </div>
                    <div>
                ...
                <div class="bg-white rounded-[2rem] p-10 border border-gray-100 shadow-xl flex flex-col h-full hover:shadow-2xl transition duration-500">
                    <div class="flex items-center mb-8">
                        ...
                        <div class="ml-6">
                            ...
                            <p class="text-sky-500 font-bold mt-1 text-sm uppercase tracking-wide">Chairman / Correspondent</p>
                        </div>
                    </div>
                    <div>
                        <p class="text-gray-600 text-lg leading-relaxed italic">
                ...
                <div class="bg-white rounded-[2rem] p-10 border border-gray-100 shadow-xl flex flex-col h-full hover:shadow-2xl transition duration-500">
                    <div class="flex items-center mb-8">
                        ...
                        <div class="ml-6">
                            ...
                            <p class="text-sky-500 font-bold mt-1 text-sm uppercase tracking-wide">Technical Director</p>
                        </div>
                    </div>
                    <div>
                        <p class="text-gray-600 text-lg leading-relaxed italic">
