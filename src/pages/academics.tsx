    ...
    <section class="py-24 bg-purple-900 text-white relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p class="text-xl mb-10 text-purple-100 font-light">
                Join Dr. SNS College of Education's Pre-Primary program and watch your child thrive.
            </p>
...
export const BEdPage = () => {
    ...
    ${PageHeader(
        'B.Ed. Programme',
        'Empowering future educators with Design Thinking and specialized pedagogy subjects',
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div>
                    <span class="text-green-600 font-bold tracking-wider uppercase text-sm mb-2 block">Teacher Education</span>
                    <h2 class="text-4xl font-bold text-gray-900 mb-6">Expertise in Pedagogy</h2>
                    <p class="text-lg text-gray-600 leading-relaxed mb-6">
                        Our B.Ed. programme is designed to create innovative educators who can redefine common minds. We focus on a wide range of pedagogy subjects, integrating Design Thinking into the teaching-learning process to prepare teachers for the challenges of the 21st-century classroom.
                    </p>
                    <p class="text-lg text-gray-600 leading-relaxed">
                        Students choose their specialized pedagogy subjects to master the art and science of teaching in their respective fields.
                    </p>
                </div>
                <div class="relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    We offer a comprehensive range of pedagogy specializations for our B.Ed. students.
                </p>
            </div>

            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ${[
            { name: 'Pedagogy of Tamil', icon: 'fa-language', color: 'text-orange-600', bg: 'bg-orange-50' },
            { name: 'Pedagogy of English', icon: 'fa-book', color: 'text-blue-600', bg: 'bg-blue-50' },
            { name: 'Pedagogy of Mathematics', icon: 'fa-calculator', color: 'text-red-600', bg: 'bg-red-50' },
            { name: 'Pedagogy of Physical Science', icon: 'fa-flask', color: 'text-indigo-600', bg: 'bg-indigo-50' },
            { name: 'Pedagogy of Biological Science', icon: 'fa-leaf', color: 'text-green-600', bg: 'bg-green-50' },
            { name: 'Pedagogy of History', icon: 'fa-landmark', color: 'text-amber-600', bg: 'bg-amber-50' },
            { name: 'Pedagogy of Computer Science', icon: 'fa-laptop-code', color: 'text-purple-600', bg: 'bg-purple-50' },
            { name: 'Pedagogy of Economics', icon: 'fa-chart-line', color: 'text-emerald-600', bg: 'bg-emerald-50' },
            { name: 'Pedagogy of Commerce', icon: 'fa-briefcase', color: 'text-cyan-600', bg: 'bg-cyan-50' },
            { name: 'Pedagogy of Social Science', icon: 'fa-users', color: 'text-rose-600', bg: 'bg-rose-50' }
        ].map(subject => `
                    <div class="bg-white rounded-2xl p-8 shadow-md hover:shadow-xl transition duration-300 border border-gray-100 group">
                        <div class="w-16 h-16 ${subject.bg} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition">
                            <i class="fas ${subject.icon} text-3xl ${subject.color}"></i>
                        </div>
    ...
    <section class="py-24 bg-green-900 text-white relative overflow-hidden">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 class="text-4xl font-bold mb-6">Become a Design Thinking Educator</h2>
            <p class="text-xl mb-10 text-green-100 font-light">
                Secure your seat in our B.Ed. programme and shape the next generation.
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/admissions" class="bg-white text-green-900 hover:bg-gray-100 px-10 py-4 rounded-full font-bold text-lg transition shadow-lg shrink-0">
                    Apply Now
                </a>
                <a href="/contact" class="bg-green-800 border border-green-700 hover:bg-green-700 px-10 py-4 rounded-full font-bold text-lg transition shrink-0">
                    Contact Admissions
                </a>
            </div>
        </div>
