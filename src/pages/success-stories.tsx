...
export const SuccessStoriesPage = () => {
                ...
                <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <div class="p-8 lg:p-12 flex flex-col justify-center">
                        ...
                        <p class="text-gray-700 text-lg mb-6 leading-relaxed">
                            The Dinamalar Pattam – Final Round was successfully held at Dr. SNS College of Education. The event concluded on a high note with prizes presented by Pavan Kumar, District Collector, Coimbatore, along with Dr. Nalin, Technical Director, SNS Institutions.
                        </p>
                        <div class="flex items-center text-sm text-gray-600 mb-6">
                            <span class="font-semibold mr-4">Dr. SNS College of Education</span>
    ...
    <script>
        ...
        const stories = {
            academic: [
                {
                    title: "State Level Best Student Teacher Award 2026",
                    description: "Dr. SNS College of Education is incredibly proud of our final year B.Ed student, Preethi M., for winning the prestigious 'State Level Best Student Teacher Award 2026'. Recognized for her innovative integration of the GenAI-Powered Design Thinking Framework in her teaching practice, she stands as a true example of our institution's commitment to creating the next generation of educators.",
                    image: "/static/images/success-new.jpg",
                    date: "March 2026",
                    category: "Academic",
                    color: "blue",
                    link: "#"
                },
                {
                    ...
                    description: "The Dinamalar Pattam – Final Round was successfully held at Dr. SNS College of Education. The event concluded on a high note with prizes presented by Pavan Kumar, District Collector, Coimbatore, along with Dr. Nalin, Technical Director, SNS Institutions.",
                ...
                },
                {
                    ...
                    description: "Hats off to S. Lakshan of Grade III, of Dr. SNS College of Education for dominating the board and emerging as the Champion at the District Level Children's Chess Tournament! His strategic mind and focus are truly remarkable. We are thrilled to celebrate his brilliant victory! Way to go, Lakshan!",
            ...
            community: [
                {
                    ...
                    description: "Our kindergarten students of Dr. SNS College of Education, joyfully stepped into the role of little chefs during a fun-filled Salad Making Activity. With colourful vegetables, curious minds, and happy smiles, children explored healthy eating while engaging in hands-on culinary learning. This delightful activity encouraged creativity, teamwork, and awareness about nutritious food—making learning both tasty and meaningful. A truly heartwarming experience where fun met healthy habits!",
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-gray-600 mb-8">
                Join Dr. SNS College of Education and become part of our legacy of excellence, innovation, and achievement!
            </p>
