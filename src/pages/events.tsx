...
export const EventsPage = () => {
    ...
    ${PageHeader(
        'Events & Celebrations',
        'Experience the vibrant life at Dr. SNS College of Education through our memorable events, celebrations, and activities',
        '/static/images/events-bg.png',
        'Events'
    )}
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <div>
                            ...
                            <p class="text-white/90 text-sm mb-3">Wishing joy, gratitude, and prosperity to all. May this harvest festival usher in new hopes and bright beginnings. Happy Pongal from SNS Institutions!</p>
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <div>
                            ...
                            <p class="text-white/90 text-sm mb-3">Students stepped into nature to learn about greenery, plants, and environmental care — a day filled with curiosity, smiles, and meaningful lessons.</p>
                            <div class="flex items-center text-white/80 text-xs space-x-4 mb-3">
                                <span><i class="fas fa-calendar mr-1"></i> Jan 2026</span>
                ...
                <!-- Event 3: Graduation Day -->
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    <div class="absolute inset-0">
                        <img src="/static/images/new_graduation_day.png" alt="Graduation Day" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                    </div>
                    <!-- Always visible title -->
                    <div class="absolute bottom-0 left-0 right-0 p-6 group-hover:opacity-0 transition-opacity duration-300">
                        <h3 class="text-white font-bold text-2xl">Graduation Day 2025</h3>
                    </div>
                    <!-- Hover overlay with full details -->
                    <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <div>
                            <h3 class="text-white font-bold text-2xl mb-2">Graduation Day 2025</h3>
                            <p class="text-white/90 text-sm mb-3">Celebrating the achievements of our graduating batch at Dr. SNS College of Education. A proud milestone — Empowering Minds, Shaping Futures.</p>
                            <div class="flex items-center text-white/80 text-xs space-x-4 mb-3">
                                <span><i class="fas fa-calendar mr-1"></i> Mar 2025</span>
                                <span><i class="fas fa-graduation-cap mr-1"></i> Celebration</span>
                            </div>
                            <a href="#" class="inline-flex items-center bg-white/20 hover:bg-white/30 backdrop-blur text-white px-4 py-2 rounded-lg text-xs font-semibold transition border border-white/30">
                                <i class="fas fa-arrow-right mr-2"></i> Read More
                            </a>
                        </div>
                    </div>
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    <div class="absolute inset-0">
                        <img src="/static/images/sports_day_celebration.jpg" alt="Sports Day" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                    </div>
                    <!-- Always visible title -->
                    <div class="absolute bottom-0 left-0 right-0 p-6 group-hover:opacity-0 transition-opacity duration-300">
                        <h3 class="text-white font-bold text-2xl">Sports Day</h3>
                    </div>
                    <!-- Hover overlay with full details -->
                    <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <div>
                            <h3 class="text-white font-bold text-2xl mb-2">Sports Day</h3>
                            <p class="text-white/90 text-sm mb-3">Students showcased their athletic spirit and teamwork during our annual Sports Day — a celebration of health, energy, and friendly competition.</p>
                            <div class="flex items-center text-white/80 text-xs space-x-4 mb-3">
                                <span><i class="fas fa-calendar mr-1"></i> Feb 2025</span>
                                <span><i class="fas fa-trophy mr-1"></i> Sports</span>
                            </div>
                            <a href="#" class="inline-flex items-center bg-white/20 hover:bg-white/30 backdrop-blur text-white px-4 py-2 rounded-lg text-xs font-semibold transition border border-white/30">
                                <i class="fas fa-arrow-right mr-2"></i> Read More
                            </a>
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="bg-purple-600 text-white px-3 py-1 rounded-full text-xs font-bold">Sports</span>
                    </div>
                </div>

                <!-- Event 5: Awareness Program -->
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    <div class="absolute inset-0">
                        <img src="/static/images/awareness_program.jpg" alt="Awareness Program" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                    </div>
                    <!-- Always visible title -->
                    <div class="absolute bottom-0 left-0 right-0 p-6 group-hover:opacity-0 transition-opacity duration-300">
                        <h3 class="text-white font-bold text-2xl">Awareness Program</h3>
                    </div>
                    <!-- Hover overlay with full details -->
                    <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <div>
                            <h3 class="text-white font-bold text-2xl mb-2">Awareness Program</h3>
                            <p class="text-white/90 text-sm mb-3">Our students actively participated in social awareness programs, demonstrating true leadership and dedication to a better community.</p>
                            <div class="flex items-center text-white/80 text-xs space-x-4 mb-3">
                                <span><i class="fas fa-calendar mr-1"></i> Jan 2026</span>
                                <span><i class="fas fa-users mr-1"></i> Social Campaign</span>
                            </div>
                            <a href="#" target="_blank" rel="noopener noreferrer" class="inline-flex items-center bg-white/20 hover:bg-white/30 backdrop-blur text-white px-4 py-2 rounded-lg text-xs font-semibold transition border border-white/30">
                                <i class="fas fa-arrow-right mr-2"></i> Read More
                            </a>
                        </div>
                    </div>
                    <div class="absolute top-4 left-4">
                        <span class="bg-red-600 text-white px-3 py-1 rounded-full text-xs font-bold">Campaign</span>
                    </div>
                </div>
                ...
                <div class="group relative overflow-hidden rounded-2xl shadow-lg cursor-pointer aspect-square">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <div>
                            ...
                            <p class="text-white/90 text-sm mb-3">Students explored Thekkady's Periyar Wildlife Sanctuary — learning about biodiversity and conservation firsthand, filled with teamwork and unforgettable memories.</p>
                            <div class="flex items-center text-white/80 text-xs space-x-4 mb-3">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-gray-600 mb-8">
                Join Dr. SNS College of Education and create unforgettable memories through our diverse events and celebrations!
            </p>
